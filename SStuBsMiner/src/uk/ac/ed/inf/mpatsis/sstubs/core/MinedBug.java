...
public class MinedBug {
	...
	protected final String fileBeforeFix, fileAfterFix;
	...
	public MinedBug( String commitSHA1, String parentCommitSHA1, String commitFile, String patch, String projectName,
			...
			int newNodeStartChar, int newNodeLength, String before, String after, String fileBeforeFix, String fileAfterFix) {
		...
		this.fileBeforeFix = fileBeforeFix;
		this.fileAfterFix = fileAfterFix;
	...
	public String toString( boolean getPatch ) {
		...
		builder.append( TAB );
		builder.append( fileBeforeFix );
		builder.append( TAB );
		builder.append( fileAfterFix );
		builder.append( "\n" );
		if ( getPatch ) {
	...
	/**
	 * @return the fileBeforeFix
	 */
	public String getFileBeforeFix() {
		return fileBeforeFix;
	}

	/**
	 * @return the fileAfterFix
	 */
	public String getFileAfterFix() {
		return fileAfterFix;
	}
